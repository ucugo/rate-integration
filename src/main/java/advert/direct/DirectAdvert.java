...
public class DirectAdvert {
	...
	public DirectAdvert(){}
	public HashMap<String, String> getAdvert(String adFormat, HttpServletRequest request)throws Exception{
		long startTime = System.currentTimeMillis();


		try {

			String responseText = getAdvert(request, Site_Id, adFormat);
			...
			if (StringUtils.isNotEmpty(responseText)) {
				if(StringUtils.equals(adFormat, "xml")){

					return convertDirectAdvertAsXMLToHashMap(document);
				}
				else {
					HashMap<String, String> out = new HashMap<String, String>();
					out.put("directAdvert", responseText);
					return out;
				}
			}
	...
	private static HashMap<String, String> convertDirectAdvertAsXMLToHashMap(Document document){
